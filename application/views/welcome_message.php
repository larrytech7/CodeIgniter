		...
		<div class="row">
			...
			<div class="col-md-8 ">
				<div class="col-container">
					...
					<div id="body">
						<p>Hello! Welcome to CodeIgniter with AdminLTE integration. This fork of the CI framework fully integrates the AdminLTE UI template to enable CI users quickly adapt this UI on their projeccts without much to add and setup.</p>

						<p>The initial view of this page is located at:</p>
						<code>application/views/welcome_message.php</code>

						<p>The corresponding controller for this page is found at:</p>
						<code>application/controllers/Welcome.php</code>

						<p> I plan to add even more features to this integration. Here are some of them.
							<ul>
								<li> Full CRUD operations for common admin components like Users, cart items, articles tc</li>
								<li> Firebase Database support for real-time database operations</li>
								<li> Firebase cloud messaging for notfications and instant message notifications</li>
								<li> Relational database events trigger for application wide message triggers</li>
						</ul>
						</p>
					</div>
				</div>
			...
			<div class="col-md-4 hold-transition login-page">
				<div class="login-box ">
					...
					<div class="login-box-body ">
						<p class="login-box-msg">Use any email/password combination. This is just a UI template</p>

						<form action="<?= site_url('welcome/home')?>" method="post" class="hold-transition ">
						...
						<a href="<?= site_url('examples/signup')?>" class="text-center">Register a new membership</a>
